...
from gym_donkeycar.envs.vae_sim import DonkeyUnitySimContoller
...
class DonkeyVAEEnv(gym.Env):
    ...
    def __init__(self, level=0, host='127.0.0.1', port=9091, frame_skip=2, vae=None, const_throttle=None,
        ...
        self.viewer = DonkeyUnitySimContoller(level=level, host=host, port=port, max_cte=max_cte_error)
